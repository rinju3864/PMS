<%@ Page Title="" Language="C#" MasterPageFile="~/Company Module/Company_MasterPage.Master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="Company_Update_Profile.aspx.cs" Inherits="Placement_Management_System.Company_Module.Company_Update_Profile" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="pnl_Basic_Details" runat="server">
        ...
        <asp:Panel ID="pnl_Company_Offerings" Visible="false" runat="server">
            ...
            <div class="wrap-input100 validate-input" data-validate="Estimated Arrival Date (To) is Required">
                <center><span style="" CssClass="lbl">Estimated Arrival Date (To)</span>
                        ...
                        <asp:Calendar ID="cld_Estimate_ArrivalDate_To" runat="server" DayHeaderStyle-BorderColor="#032152" DayHeaderStyle-BorderStyle="Solid" DayHeaderStyle-BorderWidth="2px"
                            DayStyle-BorderColor="#032152" DayStyle-BorderStyle="Solid" DayStyle-BorderWidth="2px" FirstDayOfWeek="Monday" SelectedDayStyle-ForeColor="Black" ShowGridLines="True"
                            TitleStyle-BackColor="#093051" TitleStyle-ForeColor="White" SelectionMode="Day" CellPadding="5" CellSpacing="5"  VisibleDate="2020-01-17" OnSelectionChanged="cld_Estimate_ArrivalDate_To_SelectionChanged" OnDayRender="cld_Estimate_ArrivalDate_To_DayRender">
            ...
            <%--            <center>
                        <asp:RegularExpressionValidator ID="Total_Rounds_Validator" runat="server" ErrorMessage="Please Enter Valid Total No. of Rounds Of Interview" ControlToValidate="txt_Total_Rounds" Display="Dynamic" ForeColor="Red" ValidationExpression="^[0-9]+$"></asp:RegularExpressionValidator>
                    </center>--%>
            ...
            <div class="wrap-input100 validate-input" data-validate="Last Sem SGPA Required">
                <asp:Label ID="lbl_4Sem_SGPA" runat="server" CssClass="lbl" Text="Last Semester SGPA"></asp:Label>
        ...
        <div class="container-login100-form-btn">
            <div class="wrap-login100-form-btn">
                ...
                <asp:Button ID="btn_Submit" runat="server" class="login100-form-btn" Text="Update" OnClick="btn_Submit_Click" />
            </div>
        </div>
